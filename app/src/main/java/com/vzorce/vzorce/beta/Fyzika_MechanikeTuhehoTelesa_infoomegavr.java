...
public class Fyzika_MechanikeTuhehoTelesa_infoomegavr extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fyzika__mechanike_tuheho_telesa_infoomegavr);
